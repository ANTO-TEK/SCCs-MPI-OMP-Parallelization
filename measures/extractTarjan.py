...
config = {
			...
			"table":{
				"header": ['Version','Processes', 'OMP','Tarjan','Communication','Elapsed','Speedup','Efficiency'],
			},
			"plot":{
...
if __name__ == "__main__":
	extraction(root=os.path.join(os.path.dirname(os.path.realpath(__file__)),"tarjan/measure_O0/"))
	extraction(root=os.path.join(os.path.dirname(os.path.realpath(__file__)),"tarjan/measure_O1/"))
	extraction(root=os.path.join(os.path.dirname(os.path.realpath(__file__)),"tarjan/measure_O2/"))
	extraction(root=os.path.join(os.path.dirname(os.path.realpath(__file__)),"tarjan/measure_O3/"))