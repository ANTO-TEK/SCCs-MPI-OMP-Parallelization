 ...
 * @file TInfoHTSCCs.h
 * 
 * @brief This file contains the implementation of the auxiliary info type for the THTSCCsSCC hash 
 * table.
 * 
 * @version 0.1
 * 
...
#include "../include/TInfoHTSCCs.h"

/**
* This file contains the implementation of the auxiliary info type for the THTSCCsSCC hash table.
*/
...
* @return 
*/
void infoPrintHTSCCs(TInfoHTSCCs info) {
	printf("(%d: ", info.key);
...
*/
bool infoEqualHTSCCs(TInfoHTSCCs a, TInfoHTSCCs b) {
	return a.key == b.key;
}
...
*/
bool infoLessHTSCCs(TInfoHTSCCs a, TInfoHTSCCs b) {
	return a.key < b.key;
}
...
*/
bool infoGreaterHTSCCs(TInfoHTSCCs a, TInfoHTSCCs b) {
	return a.key > b.key;
}
...
*/
unsigned hashHTSCCs(TKeyHTSCCs key) {
